DEVICE_TREE := device/samsung/d2qx
# Architecture
TARGET_ARCH := arm64
...
TARGET_PREBUILT_KERNEL := device/samsung/d2qx/prebuilt/Image-dtb
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x02000000 --tags_offset 0x01e00000 --board RILSF13A001
